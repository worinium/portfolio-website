...
<div>
    <v-hover v-slot:default="{ hover }" open-delay="200">
        <v-card flat color="transparent" max-width="350px" height="500px" :loading="loading" :elevation="hover ? 16 : 2">
            <v-card-title>
                <v-layout>
                    <v-flex>
                        <v-card :href="app.platforms[0].link" target="_blank" elevation="5" style="border-radius: 20px" width="100px" height="100px">
